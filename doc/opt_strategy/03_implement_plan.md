...
>
> 代码级实施规格：见 `04_stage_implementation_spec.md`。本文负责 Stage 编排、范围、依赖和 Gate；04 负责文件迁移、接口契约、实施步骤、量化指标、测试证据与回滚操作。
...
各 Stage 开工前，应在 `04_stage_implementation_spec.md` 中补齐对应实施工作包并通过 Definition of Ready；未满足者不得仅依据本文的定性描述直接进入编码。
